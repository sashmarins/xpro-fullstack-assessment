...
class Users(models.Model):
    ...
    role = models.CharField(db_column='ROLE', max_length=9)  # Field name made lowercase.
    ...
    client = models.ForeignKey(Clients, models.DO_NOTHING, db_column='CLIENT_ID')  # Field name made lowercase.
